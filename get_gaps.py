...
# prepare png data
if os.path.exists('downloaded_data/GAPs/v2/train/Potholes'):
    ...
    x_train0, y_train0 = gaps.load_chunk(chunk_id=0, patchsize=64, issue='ZEB_50k', subset='train', datadir='downloaded_data/GAPs')
    x_train1, y_train1 = gaps.load_chunk(chunk_id=1, patchsize=64, issue='ZEB_50k', subset='train', datadir='downloaded_data/GAPs')
...
if os.path.exists('downloaded_data/GAPs/v2/test/Potholes'):
    ...
    x_test, y_test = gaps.load_chunk(chunk_id=0, patchsize=64, issue='ZEB_50k', subset='test', datadir='downloaded_data/GAPs')
